	...
	<?php 
		...
		$args = array(
		 'post_type' => 'post',
			...
			'category_name' => 'slider', // Show only 'Slider' category posts
			'post_status' => 'publish',
				...
				<figure class="bssfig">
					<div class="figBGvfi" ></div>
						<figcaption class="vfi">
							<h3>" PUSHING BOUNDARIES,<br/> CHALLENGING THE LIMITS "</h3>
							<p>As the industry demands increases dramatically, we are devoted to pushing the boundaries and challenging the limits of skills and knowledge. From design to execution, to achieve outstanding and satisfactory results.</p>
						</figcaption>
				</figure>
