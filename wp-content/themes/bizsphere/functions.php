...
function BizSphere_scripts() {
	...
	if ( get_stylesheet_directory() != get_template_directory() ) {
		wp_enqueue_style( 'BizSphere-parent-style', get_template_directory_uri().'/style.css', array(), null, true );
	}
	//wp_enqueue_style( 'BizSphere-style', get_stylesheet_uri(), array(), null, false );
	wp_enqueue_style( 'BizSphere-style', get_template_directory_uri().'/style-v2c.css', array(), null, false );
	...
	// Karl register bootstrap CSS and JS
	wp_register_script('jquery.bootstrap.min', get_template_directory_uri() . '/inc/bootstrap/js/bootstrap.min.js', 'jquery');
	wp_enqueue_script('jquery.bootstrap.min');
	
	wp_register_style( 'bootstrap.min', get_template_directory_uri() . '/inc/bootstrap/css/bootstrap.css' );
	wp_enqueue_style( 'bootstrap.min' );
	
	// JQuery Mobile
	wp_register_script('jquery.mobile.min', get_template_directory_uri() . '/js/jquery.mobile.custom.js', 'jquery');
	wp_enqueue_script('jquery.mobile.min');
}
add_action( 'wp_enqueue_scripts', 'BizSphere_scripts' );

// Karl register custom navigation walker
